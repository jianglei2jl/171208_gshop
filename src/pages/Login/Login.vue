          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <img class="get_verification" :src="captchas" alt="captcha"
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('getCaptchas')
    },
    computed: {
      ...mapState(['captchas']),
      rightPhone () {
    ...
    methods: {
      ...
      getCaptcha () {
        // 每次指定的src要不一样
        // this.$refs.captcha.src = 'https://elm.cangdu.org/v1/captchas?time='+Date.now()
      this.$store.dispatch('getCaptchas')
