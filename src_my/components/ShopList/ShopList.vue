<template>
   <div class="shop_container">
              ...
              <li class="shop_li border-1px" v-for="(shop,index) in shops" :key="index" @click="$router.push('/shop')">
                <a>
                  <div class="shop_left">
                    ...
                    <!-- 由于图片数据没了，这里换一个随机图片 -->
                    <img class="shop_img"  v-lazy="'https://source.unsplash.com/random'">
                  </div>
            ...
            <ul v-else>
              <li v-for="(i,index) in 6" :key="index"><img src="./images/shop_back.svg" alt=""></li>
            </ul>
   </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      baseImgUrl:'http://cangdu.org:8001/img/16018a5c08533.jpeg/'
    }
  },
  methods:{
    ...mapActions(['getShops'])
