  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item " :class="`activity-${supportColor[support.type]}`" v-for="(support,index) in info.supports" :key="index">
...
export default {
  ...
  mounted(){
    ...
    //如果数据有了，才执行下面语句,创建BScroll对象形成滑动
